...
*/
/*
// This is the original full step
const int _full [4][4] = {
...
*/
/* 12-26-EZONCA: From rotaryencoder.ccp _quadrature */
const int _full [4][4] = {
    { 0, 0, 0, 0 },		//  00 -> 10 is silent CW
    { 1, 0, 0, 0 },	//  01 -> 00 is CW
    { -1, 0, 0, 0 },	//  10 -> 11 is CW
...
Quadrature::Quadrature(int pin1, int pin2):
    ...
    TIMSK4 |= (1 << TOIE4);		//  enable timer 2 overflow interrupt
